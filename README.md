...
The algorithm uses RNNoise (xiph.org) recompiled as a Windows' static library from [here](https://github.com/Dybios/rnnoise-windows), which is then compiled as an APO DLL using MinimalAPO example provided in EqualizerAPO's [developer documentation](https://sourceforge.net/p/equalizerapo/wiki/Developer%20documentation/).
