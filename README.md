...
The algorithm uses a few different ways to cancel out the noise including RNNoise's noise cancelling algorithm.

> Please note, RNNoise (from xiph.org) has been used as a statically compiled library which was recompiled as a Windows' static library from [here](https://github.com/Dybios/rnnoise-windows). This is then integrated as an APO DLL using MinimalAPO example provided in EqualizerAPO's [developer documentation](https://sourceforge.net/p/equalizerapo/wiki/Developer%20documentation/).
